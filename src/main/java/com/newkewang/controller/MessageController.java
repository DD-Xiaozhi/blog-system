...
import com.newkewang.service.MessageService;
 ...
 * @author xiaozhi
 * @description 私信功能控制器
 * @create 2022-03-2022/3/28 20:42
 */
@Controller
public class MessageController implements CommunityConstant {
    ...
    public String getLetterList(Model model, Page page) {
        ...
        if (conversationList != null) {
            for (Message message : conversationList) {
                ...
                int targetId = user.getId().intValue() == message.getFromId().intValue()
    ...
    private List<Integer> getLetterIds(List<Message> letterList) {
        ...
        if (letterList != null) {
            for (Message message : letterList) {
                if (hostHolder.getUser().getId().intValue() == message.getToId().intValue()
                        && message.getStatus() == 0) {
